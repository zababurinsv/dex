import speech from '/static/html/components/component_modules/speech/speech.mjs'
customElements.define('web-speech',
      ...
      constructor () {
        ...
        async function modules (obj) {
          await speech['get']({
            type:'speech',
            this:obj['this'],
            language: obj['this']['shadowRoot'].querySelector('#select_language'),
            dialect:obj['this']['shadowRoot'].querySelector('#select_dialect')
          })
        }
      }
      connectedCallback() {
